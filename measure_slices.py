...
parser.add_argument('--dir', default='/local_scratch/wamsterd/data/lidc/nodules2d', help='location of files, should contain subdirs with splits with subdirs imgs and masks')
